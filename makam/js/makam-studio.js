...
(function() {
    ...
    const MAKAMS = [
        { id: 'rast', name: 'Rast', lower: 'Rast', lowerIsPentachord: true, upper: 'Rast', upperIsPentachord: false, guclu: 31, seyir: SEYIR.ASCENDING, approachFrom: 9, character: 'Türk musikisinin temel makamı - ne majör ne minör, asil ve kararlı.' },
